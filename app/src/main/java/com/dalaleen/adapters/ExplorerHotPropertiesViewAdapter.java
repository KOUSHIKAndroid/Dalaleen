...
public class ExplorerHotPropertiesViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ExplorerHotPropertiesViewAdapter(ExplorerFragment explorerFragment,Context context, ArrayList<MyProperties> setGetExplorerArrayList, int Startp){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==TYPE_BOADY) {
            ...
            return new ExplorerHotPropertiesViewAdapter.MyViewHolder(itemView);
        }else if(viewType==TYPE_FOOTER) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.explorer_list_row_loader, parent, false);
            return new ExplorerHotPropertiesViewAdapter.LoaderViewHolder(itemView);
        }
        return null;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holde1, int position) {
...
//                    Pair<View, String> p2 = Pair.create((View)navigationView.findViewById(R.id.walet_amunt), "walletAmount");
    ...
    public int getItemCount() {
        Logger.showInfo("count",""+ setGetExplorerArrayList.size());
    ...
    public class LoaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public LoaderViewHolder(View itemView) {
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    explorerFragment.LoadHOTProperties(StartP);
